    ...
    <div className="space-y-4">
      ...
      <div className="rounded-lg border border-blue-500/30 bg-blue-500/10 p-4">
        ...
        <ol className="list-decimal list-inside space-y-2 text-sm text-slate-300">
          <li>Click the button below to open Fyers login page</li>
          <li>Log in with your Fyers credentials</li>
          <li>
            After authorization, you'll see a URL like:
            <code className="block mt-1 text-xs bg-slate-800 p-2 rounded">
              https://trade.fyers.in/...?auth_code=eyJ...&amp;state=...
            </code>
          </li>
          <li>
            Copy the <strong>auth_code</strong> value from the URL (everything after{' '}
            <code className="text-xs">auth_code=</code> and before <code className="text-xs">&amp;</code>)
          </li>
      ...
      <div>
        ...
        <textarea
          ...
          placeholder="Paste the auth_code value here (starts with eyJ...)"
          rows={3}
        ...
        <p className="mt-1 text-xs text-slate-500">
          The authorization code is a long string starting with "eyJ"
        </p>
      </div>
