"""US swing strategy driven by the offline research artifacts."""
...
from src.research.us_swing_live import DEFAULT_US_SWING_REPORT_DIR, USSwingLiveScorer
...
class USSwingRadarStrategy(BaseStrategy):
    """Trade multi-day US equity swings discovered by the research pipeline."""

    name = "US_Swing_Radar"

    def __init__(
        self,
        report_dir: str = str(DEFAULT_US_SWING_REPORT_DIR),
        preferred_execution_timeframe: str = "15",
        min_signal_score: float = 60.0,
        min_direction_probability: float = 0.42,
        ...
        self._scorer = USSwingLiveScorer(report_dir=self.report_dir)
    ...
    def generate_signals(self, data: pd.DataFrame) -> list[Signal]:
        ...
        metadata: dict[str, Any] = {
            ...
            "signal_source": "us_swing_research",
    ...
    def __repr__(self) -> str:
        return (
            f"<USSwingRadarStrategy(tf={self.preferred_execution_timeframe}, "
